...
%     load =  dados_matriz_MPS.mat;    % dados do mps

%     nest=13;                    %Horas do Fundeio (Ex: 13 ou 26 horas)

    oxii = 0;             % Tem dados de oxigenio troca (sim =1; nao = 0)
    sp = 0;              % Tem dados de mps troca (sim =1; nao = 0)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  save dados_hidro.mat SS TT MM OO
