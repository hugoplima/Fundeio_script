...
% clear all
   ...
   PCU1 = pcu(:,1); VE1 = vve(:,1); VN1 = vvn(:,1);  %%% renomeando as variaveis
   
   
   save corrente_matriz.mat PCU1 VE1 VN1 nest      %%% salvando matriz para o programa Estuario e isopleta
   
   
   delete pcu.txt; delete vve.txt; delete vvn.txt;   %%% deletando dados da ganbiarra  
